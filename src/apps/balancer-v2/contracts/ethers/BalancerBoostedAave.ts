...
export interface BalancerBoostedAaveInterface extends utils.Interface {
  functions: {
...
export interface BalancerBoostedAave extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BalancerBoostedAaveInterface;
