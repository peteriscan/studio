...
export interface BalancerWrappedAaveInterface extends utils.Interface {
  functions: {
...
export interface BalancerWrappedAave extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BalancerWrappedAaveInterface;
