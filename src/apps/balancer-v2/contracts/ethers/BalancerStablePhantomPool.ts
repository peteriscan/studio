...
export type DueProtocolFeeIncreasedEvent = TypedEvent<[BigNumber], DueProtocolFeeIncreasedEventObject>;
...
export type TokenRateCacheUpdatedEvent = TypedEvent<[string, BigNumber], TokenRateCacheUpdatedEventObject>;
...
export type TokenRateProviderSetEvent = TypedEvent<[string, string, BigNumber], TokenRateProviderSetEventObject>;
